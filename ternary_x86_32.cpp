...
SIMDE_FUNCTION_ATTRIBUTES
uint32_t
simde_x_ternarylogic_0x03_impl_(uint32_t A, uint32_t B) {
    const uint32_t t0 = B | A;
    const uint32_t t1 = ~t0;
    return t1;
}
...
SIMDE_FUNCTION_ATTRIBUTES
uint32_t
simde_x_ternarylogic_0x05_impl_(uint32_t A, uint32_t C) {
...
SIMDE_FUNCTION_ATTRIBUTES
uint32_t
simde_x_ternarylogic_0x0a_impl_(uint32_t A, uint32_t C) {
    const uint32_t t0 = ~A;
...
SIMDE_FUNCTION_ATTRIBUTES
uint32_t
simde_x_ternarylogic_0x0c_impl_(uint32_t A, uint32_t B) {
    const uint32_t t0 = ~A;
...
SIMDE_FUNCTION_ATTRIBUTES
uint32_t
simde_x_ternarylogic_0x0f_impl_(uint32_t A) {
    const uint32_t t0 = ~A;
    return t0;
}
...
SIMDE_FUNCTION_ATTRIBUTES
uint32_t
simde_x_ternarylogic_0x11_impl_(uint32_t B, uint32_t C) {
...
SIMDE_FUNCTION_ATTRIBUTES
uint32_t
simde_x_ternarylogic_0x22_impl_(uint32_t B, uint32_t C) {
    const uint32_t t0 = ~B;
    const uint32_t t1 = C & t0;
    return t1;
}
...
SIMDE_FUNCTION_ATTRIBUTES
uint32_t
simde_x_ternarylogic_0x30_impl_(uint32_t A, uint32_t B) {
    const uint32_t t0 = ~B;
    const uint32_t t1 = A & t0;
    return t1;
}
...
SIMDE_FUNCTION_ATTRIBUTES
uint32_t
simde_x_ternarylogic_0x33_impl_(uint32_t B) {
    const uint32_t t0 = ~B;
    return t0;
}
...
SIMDE_FUNCTION_ATTRIBUTES
uint32_t
simde_x_ternarylogic_0x3c_impl_(uint32_t A, uint32_t B) {
    const uint32_t t0 = B ^ A;
    return t0;
}
...
SIMDE_FUNCTION_ATTRIBUTES
uint32_t
simde_x_ternarylogic_0x3f_impl_(uint32_t A, uint32_t B) {
    const uint32_t t0 = B & A;
    const uint32_t t1 = ~t0;
    return t1;
}
...
SIMDE_FUNCTION_ATTRIBUTES
uint32_t
simde_x_ternarylogic_0x44_impl_(uint32_t B, uint32_t C) {
    const uint32_t t0 = ~C;
    const uint32_t t1 = B & t0;
    return t1;
}
...
SIMDE_FUNCTION_ATTRIBUTES
uint32_t
simde_x_ternarylogic_0x50_impl_(uint32_t A, uint32_t C) {
    const uint32_t t0 = ~C;
    const uint32_t t1 = A & t0;
    return t1;
}
...
SIMDE_FUNCTION_ATTRIBUTES
uint32_t
simde_x_ternarylogic_0x55_impl_(uint32_t C) {
    const uint32_t t0 = ~C;
    return t0;
}
...
SIMDE_FUNCTION_ATTRIBUTES
uint32_t
simde_x_ternarylogic_0x5a_impl_(uint32_t A, uint32_t C) {
    const uint32_t t0 = C ^ A;
    return t0;
}
...
SIMDE_FUNCTION_ATTRIBUTES
uint32_t
simde_x_ternarylogic_0x5f_impl_(uint32_t A, uint32_t C) {
    const uint32_t t0 = C & A;
    const uint32_t t1 = ~t0;
    return t1;
}
...
SIMDE_FUNCTION_ATTRIBUTES
uint32_t
simde_x_ternarylogic_0x66_impl_(uint32_t B, uint32_t C) {
    const uint32_t t0 = C ^ B;
    return t0;
}
...
SIMDE_FUNCTION_ATTRIBUTES
uint32_t
simde_x_ternarylogic_0x77_impl_(uint32_t B, uint32_t C) {
    const uint32_t t0 = C & B;
    const uint32_t t1 = ~t0;
    return t1;
}
...
SIMDE_FUNCTION_ATTRIBUTES
uint32_t
simde_x_ternarylogic_0x88_impl_(uint32_t B, uint32_t C) {
    const uint32_t t0 = C & B;
    return t0;
}
...
SIMDE_FUNCTION_ATTRIBUTES
uint32_t
simde_x_ternarylogic_0x99_impl_(uint32_t B, uint32_t C) {
    const uint32_t t0 = C ^ B;
    const uint32_t t1 = ~t0;
    return t1;
}
...
SIMDE_FUNCTION_ATTRIBUTES
uint32_t
simde_x_ternarylogic_0xa0_impl_(uint32_t A, uint32_t C) {
    const uint32_t t0 = C & A;
    return t0;
}
...
SIMDE_FUNCTION_ATTRIBUTES
uint32_t
simde_x_ternarylogic_0xa5_impl_(uint32_t A, uint32_t C) {
    const uint32_t t0 = C ^ A;
    const uint32_t t1 = ~t0;
    return t1;
}
...
SIMDE_FUNCTION_ATTRIBUTES
uint32_t
simde_x_ternarylogic_0xaa_impl_(uint32_t C) {
    return C;
}
...
SIMDE_FUNCTION_ATTRIBUTES
uint32_t
simde_x_ternarylogic_0xaf_impl_(uint32_t A, uint32_t C) {
    const uint32_t t0 = ~A;
    const uint32_t t1 = C | t0;
    return t1;
}
...
SIMDE_FUNCTION_ATTRIBUTES
uint32_t
simde_x_ternarylogic_0xbb_impl_(uint32_t B, uint32_t C) {
    const uint32_t t0 = ~B;
    const uint32_t t1 = C | t0;
    return t1;
}
...
SIMDE_FUNCTION_ATTRIBUTES
uint32_t
simde_x_ternarylogic_0xc0_impl_(uint32_t A, uint32_t B) {
    const uint32_t t0 = B & A;
    return t0;
}
...
SIMDE_FUNCTION_ATTRIBUTES
uint32_t
simde_x_ternarylogic_0xc3_impl_(uint32_t A, uint32_t B) {
    const uint32_t t0 = B ^ A;
    const uint32_t t1 = ~t0;
    return t1;
}
...
SIMDE_FUNCTION_ATTRIBUTES
uint32_t
simde_x_ternarylogic_0xcc_impl_(uint32_t B) {
    return B;
}
...
SIMDE_FUNCTION_ATTRIBUTES
uint32_t
simde_x_ternarylogic_0xcf_impl_(uint32_t A, uint32_t B) {
    const uint32_t t0 = ~A;
    const uint32_t t1 = B | t0;
    return t1;
}
...
SIMDE_FUNCTION_ATTRIBUTES
uint32_t
simde_x_ternarylogic_0xdd_impl_(uint32_t B, uint32_t C) {
    const uint32_t t0 = ~C;
    const uint32_t t1 = B | t0;
    return t1;
}
...
SIMDE_FUNCTION_ATTRIBUTES
uint32_t
simde_x_ternarylogic_0xee_impl_(uint32_t B, uint32_t C) {
    const uint32_t t0 = C | B;
    return t0;
}
...
SIMDE_FUNCTION_ATTRIBUTES
uint32_t
simde_x_ternarylogic_0xf0_impl_(uint32_t A) {
    return A;
}
...
SIMDE_FUNCTION_ATTRIBUTES
uint32_t
simde_x_ternarylogic_0xf3_impl_(uint32_t A, uint32_t B) {
    const uint32_t t0 = ~B;
    const uint32_t t1 = A | t0;
    return t1;
}
...
SIMDE_FUNCTION_ATTRIBUTES
uint32_t
simde_x_ternarylogic_0xf5_impl_(uint32_t A, uint32_t C) {
    const uint32_t t0 = ~C;
    const uint32_t t1 = A | t0;
    return t1;
}
...
SIMDE_FUNCTION_ATTRIBUTES
uint32_t
simde_x_ternarylogic_0xfa_impl_(uint32_t A, uint32_t C) {
    const uint32_t t0 = C | A;
    return t0;
}
...
SIMDE_FUNCTION_ATTRIBUTES
uint32_t
simde_x_ternarylogic_0xfc_impl_(uint32_t A, uint32_t B) {
    const uint32_t t0 = B | A;
    return t0;
}
...
SIMDE_FUNCTION_ATTRIBUTES
uint32_t
simde_x_ternarylogic_0xff_impl_(uint32_t C) {
    const uint32_t c1 = UINT32_C(-1);
    return c1;
}
